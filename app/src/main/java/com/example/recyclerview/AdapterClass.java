...
public class AdapterClass extends RecyclerView.Adapter<AdapterClass.ViewHolder> { // we have to make the adapter class a child of recycler view
    ...
    ArrayList <CatModel> data = new ArrayList<>(); // HERE WE CAN'T USE AN ARRAY AS IT STORES THE SAME TYPE OF DATA, SO WE HAVE TO USE AN ARRAYLIST WHICH CAN HAVE DIFFERENT TYPE OF DATA.

    public AdapterClass(ArrayList<CatModel> data) {
        this.data = data;
    }
    ...
    public AdapterClass.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.catview_item, null));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            desc = itemView.findViewById(R.id.catFact);
        }
    }
}
